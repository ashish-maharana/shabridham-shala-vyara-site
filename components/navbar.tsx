...
export function Navbar() {
  ...
  return (
    <header className="nav-learnify">
      ...
      <div className="hidden items-center gap-3 md:flex"><Link href="/contact" className="rounded-xl bg-white px-4 py-2 text-xs font-black">Visit</Link><Link href="/admissions" className="rounded-xl bg-[var(--coral)] px-4 py-2 text-xs font-black text-white">Admission</Link></div>
