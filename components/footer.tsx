  ...
  return (
    <footer className="footer-panel section-gap">
      <div className="grid gap-10 lg:grid-cols-[1.2fr_.75fr_.75fr_.9fr]">
        <div><div className="flex items-center gap-3"><Image src={placeholderAssets.logo} alt="Shabridham logo placeholder" width={64} height={64} className="rounded-full object-cover" /><h3 className="text-3xl font-black">{site.name}</h3></div><p className="body-copy mt-5 max-w-md">A playful Learnify-style website concept for Shabridham Shala, Vyara, with Gujarati learning, activities, digital readiness, and parent-friendly admissions guidance.</p></div>
